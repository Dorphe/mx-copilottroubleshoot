    ...
    tools: {
      show_troubleshooting_card: tool({
        ...
        inputSchema: z.object({
          recommendation: z
            .string()
            .describe("The detailed step-by-step recommendation for the technician"),
          sources: z
            .array(z.string())
            .describe('Array of manual page references, e.g. "Operator\'s Manual, p. 60 — Checking coolant level"'),
        }),
      }),
      show_escalation_card: tool({
        ...
        inputSchema: z.object({
          ...
          expert_title: z.string().describe("Title/role of the specialist"),
          availability: z.string().describe("When the specialist is available"),
          reason: z
            .string()
            .describe("Brief explanation of why escalation is recommended"),
        }),
      }),
